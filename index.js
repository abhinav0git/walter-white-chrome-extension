  ...
  try {
    ...
    if (!response.ok) {
      ...
      try {
        ...
        // if res is not JSON, use statusText
...
function parseStructuredText(text) {
    ...
    for (const line of lines) {
        ...
        if (trimmedLine.toLowerCase().startsWith('hiring company:')) {
            ...
            currentSection = null; hasFoundStructuredData = true;
            ...
            currentSection = 'actions'; hasFoundStructuredData = true;
